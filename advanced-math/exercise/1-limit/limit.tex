...
$\xRightarrow{\text{令} t=1-x} -\lim\limits_{t\to 0^+}t\ln t$
...
\textcolor{orange}{当极限式子中含有分式中一般都需要用其倒数，把分式换成整式方便计算。}
...
$\xRightarrow{\text{令} t=\dfrac{1}{x^2}}  \lim\limits_{t\to+\infty}\dfrac{e^{-t}}{t^{-50}}$\medskip
